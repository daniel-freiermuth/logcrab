...
pub trait LogCrabTab {
    ...
    fn render(&mut self, ui: &mut egui::Ui, data_state: &mut LogView, global_config: &mut GlobalConfig);
    fn process_events(&mut self, events: Vec<InputAction>, data_state: &mut LogView);
...
impl TabViewer for LogCrabTabViewer<'_> {
    ...
    fn on_close(&mut self, tab: &mut Self::Tab) -> OnCloseResponse {
        tab.on_close(&mut self.filter_to_remove)
    }
}
